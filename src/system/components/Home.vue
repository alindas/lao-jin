  ...
  <div class="container" v-visibility-change="tabChange">
    <div class="sidebar" :style="barSideStyle">
      <div
        ...
        :style="barSideWrapperStyle"
        @mouseenter="enterSideBar"
        @mouseleave="leaverSideBar"
      >
        <div class="logo">
          <h1 v-show="isLock || sidebarHover">捞金管理系统</h1>
          <div class="action" @click="retract">
            <span class="icon" :style="actionStyle"
              ><icon :name="isLock ? 'lock' : 'unlock'" scale="2"></icon
            ></span>
          </div>
        </div>
        <div class="menu">
          ...
          >
            <el-menu-item
              index="1"
              @click="changeMenu('1', '信息审核', 'VerifyInfo', 1)"
            >
            ...
            <el-menu-item
              index="2"
              @click="changeMenu('2', '用户列表', 'SysUserList', 1)"
            >
            ...
            <el-menu-item
              index="3"
              @click="changeMenu('3', '任务计划列表', 'SysPlanList', 1)"
            >
              <i class="el-icon-document"></i>
              <span slot="title" v-show="isLock || sidebarHover"
                >任务计划列表</span
              >
            </el-menu-item>
            <el-menu-item
              index="4"
              @click="changeMenu('4', '系统管理', 'SysSetUp', 1)"
            >
    ...
    <div class="main">
      ...
      <div class="nav">
        ...
        <div class="menu-tag-list">
          <el-tag
            color="#fff"
            @click="changeMenu(null, '', 'SysHome', 0)"
            :type="currentMenu == null ? '' : 'info'"
            >首页</el-tag
          >
          <el-tag
